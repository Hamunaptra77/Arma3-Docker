...
GAMEDIR="$HOME/Steam/steamapps/common/Arma3 - Dedicated Server/DedicatedServer"
...
eval "$STEAMCMD +app_update 233780 +quit"
...
/opt/wine-staging/bin/wine ./arma3server.exe -batchmode -nographics -logFile Logs/current.log "$@" &> Logs/wine.log
